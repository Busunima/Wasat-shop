...
> Статус: **инициализирован** (Vite + React + TS). Реализован первый срез —
> FR-S01 (список магазинов с поиском) + FR-S02 (блокировка/тариф). FR-S03/S04/S05
> (тарифные планы, глобальная аналитика, биллинг) — следующими срезами.
> Разрабатывается **отдельно** от MVP мобильного приложения (+150–250 ч, см.
> [`../docs/roadmap.md`](../docs/roadmap.md)).
>
> Вход в панель: роль `superadmin` выдаётся на сервере —
> `cd server && npm run grant-superadmin -- <uid>` (нужны прод-креды Admin SDK).
